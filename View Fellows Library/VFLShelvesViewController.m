...
{
    static NSString *CellIdentifier = @"ShelfNameCell";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];

 //   FellowsShelf *shelfAtIndex = [self.shelvesDataController objectsInListAtIndex:indexPath.row];
